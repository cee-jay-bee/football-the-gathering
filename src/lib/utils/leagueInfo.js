/*   STEP 1   */
export const leagueID = "941406981435277312"; // your league ID 1048339646771503104
export const leagueName = "Football The Gathering"; // your league name
...
export const homepageText = `
  ...
  <p>While the ultimate prize is bragging rights and sending obnoxious texts to the rest of the league (looking at you, Ricky) for the next year, the champion manager also walks away with $280 and bragging rights for the next year.</p>
`;
...
export const managers = [
  {
    ...
    "rival": {
      name: "Ricky Hudson", // Can be anything (usually your rival's name)
  ...
  },
  {
    ...
    "rival": {
      name: "Kim Leung", // Can be anything (usually your rival's name)
